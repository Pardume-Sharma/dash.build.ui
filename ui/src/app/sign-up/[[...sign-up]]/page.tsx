      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-2">
            Join <span className="text-cyan-400">dash.build</span>
          </h1>
          <p className="text-gray-400 text-lg">
            Create your account and start building amazing dashboards
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-400">
            ...
            <a href="/sign-in" className="text-cyan-400 hover:text-cyan-300 font-medium">
              Sign in
            </a>
          </p>
        </div>
